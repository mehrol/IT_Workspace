...
class Video(Base):
    ...
    source_url: Mapped[str] = mapped_column(String(900), nullable=True)
    direct_play_url: Mapped[str] = mapped_column(String(900), nullable=True)
    embed_url: Mapped[str] = mapped_column(String(900), nullable=True)
    external_platform: Mapped[str] = mapped_column(String(60), nullable=True, index=True)
    thumbnail_url: Mapped[str] = mapped_column(String(900), nullable=True)
    poster_path: Mapped[str] = mapped_column(String(500), nullable=True)
    hls_path: Mapped[str] = mapped_column(String(500), nullable=True)
    caption_path: Mapped[str] = mapped_column(String(500), nullable=True)
...
class FreelancerProfile(Base):
    ...
    location: Mapped[str] = mapped_column(String(160), nullable=True)
    experience: Mapped[str] = mapped_column(String(120), nullable=True)
    skills: Mapped[str] = mapped_column(String(500), nullable=True, index=True)
    bio: Mapped[str] = mapped_column(Text, nullable=True)
    email: Mapped[str] = mapped_column(String(180), nullable=True)
    phone: Mapped[str] = mapped_column(String(80), nullable=True)
    portfolio_url: Mapped[str] = mapped_column(String(700), nullable=True)
